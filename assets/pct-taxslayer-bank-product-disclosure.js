...
(function () {
  ...
  const legalParagraphs = Object.freeze([
    ...
    'Because our ability to disclose your tax return information to another institution affects the service(s) that we provide to you and its (their) cost, we may decline to provide you with the tax return preparation services or change the terms (including the cost) of the tax return preparation services that we provide to you.',
    'Your consent is valid for the amount of time that you specify. If you do not specify the duration of your consent, your consent is valid for one year.',
    'For your convenience, we have entered into agreements with a bank to provide qualifying taxpayers with the opportunity to apply for a (bank product) Refund Transfer (RT) and/or Loan via Electronic Refund Check or Electronic Refund Deposit.',
    'In order to provide you with the opportunity to apply for one of these Products or Services, we must disclose all of your tax return information to our partnered financial institution.',
